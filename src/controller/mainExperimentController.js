...
function MainExperimentController(experiment, options) {
  ...
  async function endExperiment() {
    ...
    // copy all data that is reset, because writing is asynchronous
    let results = {
      _description: "",   // will be filled out below after resolving userIdPromise
    ...
    userIdPromise.then(userId => {  
      results._description = "Experiments results data for participant #" + userId + " -- generated by stimsrv v" + stimsrvVersion;
      storage.storeParticipantData(userIdPromise, results);
    });
