var stimsrvClient = (function () {
	...
	var protocol$1 = socket$1.protocol; // this is an int
	var Transport = transport;
	var transports = transports$1;
	var parser = lib$1;
	lib.Socket = Socket_1;
	lib.protocol = protocol$1;
	...
	function clientFactory$1(socket) {
	  return {
	      ...
	      return new Promise((resolve, reject) => {
	        ...
	        socket.on(protocol.CALIBRATE_TIME_RESPONSE, (data) => {
	          ...
	          if (--options.iterations > 0) {
	            ...
	            clientFactory$1.timestampAdjust = timestampAdjust;
	...
	var clientBrowser = clientFactory;
